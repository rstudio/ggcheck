...
cat(
  "<hr />",
  '<p>ggcheck is built for use with <a href="https://rstudio.github.io/learnr/">learnr</a> interactive tutorials.',
  ...
  '<a href="https://rmarkdown.rstudio.com">rmarkdown.rstudio.com</a>.</p>'
)
```
